...
Picture yourself as the CEO of a media conglomerate in the early 2000s. Your profits are dependent on the share of the market you hold, but that market share is constantly being siphoned off by competitors with similar offerings. The functional features that your network once prided itself on---being first on the scene or having exclusive coverage---begins to dry up as the internet democratizes the information space. You're left asking yourself:
...
To test these, we'll focus on the final 100 iterations the simulations. I'm defining a dedicated viewer as any agent who samples from a single outlet on at least 80 of the last 100 iterations.
