...
While some pilot testing would help to confirm the feasibility of these changes and more fine-tuning could benefit the exact parameters of the new Banker's algorithm, it seems The Banker might benefit from a crash-course in behavioral economics.
